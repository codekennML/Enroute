                    ...
                    <View className=''>
                        ...
                        <View className='mt-2 '>
                            ...
                            <View className='flex-row items-center gap-x-2 justify-between'>
                                ...
                                <Button variant={"ghost"} onPress={handleChangeEmail} className='flex-row justify-center items-center'>
                                    <Text className='text-primary dark:text-primary font-medium'>Edit</Text>
                                </Button>
                            </View>
                        </View>
                        ...
                        <View className='mt-2'>
                            ...
                            <View className='flex-row items-center justify-between gap-x-2'>
                                ...
                                <Button variant={"ghost"} onPress={handleChangeMobile} className='flex-row justify-center items-center'>
                                    <Text className='text-primary dark:text-primary font-medium'>Edit</Text>
