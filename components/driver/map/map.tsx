...
const Map = () => {
    ...
    const { destination, origin } = tripInfo
    ...
    return (
        <View style={styles.container} >
            ...
            >
                ...
                /> */}
                <Marker coordinate={{ latitude: origin?.coordinates[0]!, longitude: origin?.coordinates[1]! }} image={require("../../../assets/images/mappin.png")} />


                {/* <CustomUserMarker coordinates={{ latitude: destination.lat, longitude: destination.lng }}
                    arrivalTime={10} /> */}
